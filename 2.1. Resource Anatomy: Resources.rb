...
Resource types:
  ...
  * The CloudFormation resource classes are defined in the halloumi-resources library, see: https://github.com/sentiampc/halloumi-resources/blob/develop/lib/halloumi/resources/aws/s3/bucket.rb
